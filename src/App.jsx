...
// This will show an error in StackBlitz preview, which is normal.
...
try {
    if (firebaseConfig.apiKey) {
        ...
        throw new Error("Firebase config not found. This is normal in StackBlitz preview.");
    }
} catch (error) {
...
export default function App() {
    ...
    const renderView = () => {
        if (!auth) {
            return <div className="text-white text-center">Connecting to Firebase...</div>
        }
